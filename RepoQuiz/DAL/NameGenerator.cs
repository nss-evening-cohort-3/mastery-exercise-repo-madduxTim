...
namespace RepoQuiz.DAL
{
    public class NameGenerator
    {
        ...
        public string CreateFirstName()
        {
            ...
            int FirstNameNum = randomFirst.Next(0, FirstNames.Count() - 1);
        ...
        public string CreateLastName()
        {
            ...
            int LastNameNum = randomLast.Next(0, LastNames.Count() - 1);
        ...
        public string CreateMajor()
        {
            ...
            int MajorNumber = randomMajor.Next(0, Majors.Count() - 1);
